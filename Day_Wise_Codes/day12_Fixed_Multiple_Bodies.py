...
state=np.array([1.0,0.0,0.0,1.3])
...
earth = plt.Circle((0,0), 8e-2, fill=True,color="blue")
moon = plt.Circle((x_moon,y_moon),8e-2, fill=True,color="red")
...
ax[1][1].set_ylabel("Radius from Earth")
ax[1][1].grid()
